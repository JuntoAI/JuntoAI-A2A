...
- [ ] 1. Define Pydantic V2 request/response models
  - [ ] 1.1 Create `backend/app/models/integrations.py` with all Pydantic V2 models
  ...
  - [ ]* 1.2 Write property test for Pydantic model serialization round-trip
...
- [ ] 2. Implement API Key persistence layer (dual-mode)
  - [ ] 2.1 Add `ApiKeyStore` Protocol to `backend/app/db/base.py`
  ...
  - [ ] 2.2 Create `backend/app/db/api_key_store.py` with Firestore and SQLite implementations
  ...
  - [ ] 2.3 Add `get_api_key_store()` factory function to `backend/app/db/__init__.py`
...
- [ ] 3. Implement API Key Service
  - [ ] 3.1 Create `backend/app/services/api_key_service.py`
  ...
  - [ ]* 3.2 Write property test for API key generation and validation round-trip
  ...
  - [ ]* 3.3 Write property test for API key record completeness
  ...
  - [ ]* 3.4 Write property test for rate limit enforcement
...
- [ ] 4. Implement API key auth dependency and context injection
  - [ ] 4.1 Create `backend/app/middleware/api_key_auth.py`
  ...
  - [ ]* 4.2 Write property test for scope-based access control
  ...
  - [ ] 4.3 Implement context injection in `backend/app/services/integration_service.py` (context methods only)
  ...
  - [ ]* 4.4 Write property test for context preamble round-trip
  ...
  - [ ]* 4.5 Write property test for context injection preserving original prompt
...
- [ ] 6. Implement Webhook Dispatcher
  - [ ] 6.1 Create `backend/app/services/webhook_dispatcher.py`
  ...
  - [ ]* 6.2 Write property test for HMAC-SHA256 webhook signature correctness
...
- [ ] 7. Implement Integration Service (simulation orchestration)
  - [ ] 7.1 Complete `backend/app/services/integration_service.py` with simulation orchestration
  ...
  - [ ]* 7.2 Write property test for scenario list field filtering
  ...
  - [ ]* 7.3 Write property test for session status excluding internal data
  ...
  - [ ]* 7.4 Write property test for email triggered_by setting owner and integration metadata
  ...
  - [ ]* 7.5 Write property test for non-email triggered_by using synthetic owner
...
- [ ] 8. Implement Integration Router and wire everything together
  - [ ] 8.1 Create `backend/app/routers/integrations.py` with all endpoints
  ...
  - [ ] 8.2 Add integration settings to `backend/app/config.py`
  ...
  - [ ] 8.3 Register integration router in `backend/app/main.py`
  ...
  - [ ]* 8.4 Write property test for rate limit header consistency
  ...
  - [ ]* 8.5 Write property test for error response format consistency
...
- [ ] 10. Write unit and integration tests
  - [ ]* 10.1 Write unit tests for API key service in `backend/tests/unit/integration_api/test_api_key_service.py`
  ...
  - [ ]* 10.2 Write unit tests for context injector in `backend/tests/unit/integration_api/test_context_injector.py`
  ...
  - [ ]* 10.3 Write unit tests for webhook dispatcher in `backend/tests/unit/integration_api/test_webhook_dispatcher.py`
  ...
  - [ ]* 10.4 Write unit tests for integration models in `backend/tests/unit/integration_api/test_integration_models.py`
  ...
  - [ ]* 10.5 Write integration tests in `backend/tests/integration/test_integration_endpoints.py`
