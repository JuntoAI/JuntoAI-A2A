...
- [ ] 1. Scaffold Next.js 14 App Router project with Tailwind CSS and Lucide React
  - [ ] 1.1 Initialize Next.js 14+ project in `frontend/` with TypeScript, App Router (`app/` directory), and Tailwind CSS
  ...
  - [ ] 1.2 Create root layout (`app/layout.tsx`) and global CSS (`app/globals.css`)
  ...
  - [ ] 1.3 Create placeholder landing page (`app/page.tsx`)
    - Minimal page component returning a heading — confirms the scaffold works
    - _Requirements: 2.1_

- [ ] 2. Implement Firebase client and waitlist service
  - [ ] 2.1 Create Firebase singleton module (`lib/firebase.ts`)
  ...
  - [ ]* 2.2 Write property test for Firebase env var validation
  ...
  - [ ] 2.3 Create token helper functions (`lib/tokens.ts`)
  ...
  - [ ]* 2.4 Write property test for UTC date consistency
  ...
  - [ ]* 2.5 Write property test for token balance display formatting
  ...
  - [ ] 2.6 Create waitlist service (`lib/waitlist.ts`)
  ...
  - [ ]* 2.7 Write property test for new waitlist document structure
  ...
  - [ ]* 2.8 Write property test for idempotent re-submission
...
- [ ] 4. Implement Session Context and Access Gate
  - [ ] 4.1 Create Session Context (`context/SessionContext.tsx`)
  ...
  - [ ]* 4.2 Write property test for session state loaded on auth
  ...
  - [ ] 4.3 Create Next.js middleware (`middleware.ts`)
  ...
  - [ ]* 4.4 Write property test for access gate blocks unauthenticated users
  ...
  - [ ]* 4.5 Write property test for access gate allows authenticated users
  ...
  - [ ] 4.6 Create protected layout (`app/(protected)/layout.tsx`)
  ...
  - [ ] 4.7 Create placeholder arena page (`app/(protected)/arena/page.tsx`)
    - Minimal protected page to verify the gate works end-to-end
    - _Requirements: 4.1_

- [ ] 5. Implement Landing Page and Waitlist Form
  - [ ] 5.1 Create WaitlistForm component (`components/WaitlistForm.tsx`)
  ...
  - [ ]* 5.2 Write property test for invalid email rejection
  ...
  - [ ]* 5.3 Write property test for error display on Firestore failure
  ...
  - [ ]* 5.4 Write property test for token daily reset logic
  ...
  - [ ] 5.5 Build Landing Page (`app/page.tsx`)
...
- [ ] 7. Implement Token Display and Backend Sync
  - [ ] 7.1 Create TokenDisplay component (`components/TokenDisplay.tsx`)
  ...
  - [ ] 7.2 Implement token balance sync from backend response
  ...
  - [ ]* 7.3 Write property test for token balance sync from backend
  ...
  - [ ]* 7.4 Write property test for insufficient tokens disables action
...
- [ ] 8. Create Firestore Security Rules
  - [ ] 8.1 Write `firestore.rules` file at `frontend/firestore.rules`
  ...
  - [ ]* 8.2 Write property test for waitlist document write validation (Security Rules)
  ...
  - [ ]* 8.3 Write property test for waitlist document read scoping (Security Rules)
  ...
  - [ ]* 8.4 Write property test for default deny (Security Rules)
...
- [ ] 9. Set up Vitest testing infrastructure
  - [ ] 9.1 Configure Vitest with React Testing Library and fast-check
  ...
  - [ ] 9.2 Install `@firebase/rules-unit-testing` for security rules tests
