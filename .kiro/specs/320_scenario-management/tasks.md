...
- [ ] 1. Extend SessionStore protocol and implementations
  - [ ] 1.1 Add `list_sessions_by_scenario` and `delete_session` to SessionStore protocol
    - Add both method signatures to `backend/app/db/base.py` `SessionStore` protocol
    - _Requirements: 6.1, 6.2_

  - [ ] 1.2 Implement `list_sessions_by_scenario` and `delete_session` on `FirestoreSessionClient`
  ...
  - [ ] 1.3 Implement `list_sessions_by_scenario` and `delete_session` on `SQLiteSessionClient`
  ...
  - [ ]* 1.4 Write property test: Session lookup returns exactly matching sessions (Property 1)
  ...
  - [ ]* 1.5 Write property test: Session deletion removes the session (Property 5)
  ...
  - [ ]* 1.6 Write unit tests for SQLiteSessionClient new methods
...
- [ ] 2. Add CustomScenarioStore.update() method
  - [ ] 2.1 Implement `update()` on `CustomScenarioStore` (Firestore)
  ...
  - [ ] 2.2 Implement `update()` on `SQLiteCustomScenarioStore`
    - `UPDATE custom_scenarios SET scenario_json = ?, updated_at = ? WHERE scenario_id = ? AND email = ?`
    - Return `True` if `rowcount > 0`, else `False`
    - _Requirements: 5.3, 5.6_

  - [ ]* 2.3 Write property test: Scenario update round-trip preserves data (Property 3)
  ...
  - [ ]* 2.4 Write unit tests for CustomScenarioStore.update
...
- [ ] 4. Implement PUT /builder/scenarios/{scenario_id} endpoint
  - [ ] 4.1 Add `UpdateScenarioRequest` model and PUT endpoint to builder router
  ...
  - [ ]* 4.2 Write property test: Validation gate accepts valid and rejects invalid scenarios (Property 4)
  ...
  - [ ]* 4.3 Write unit tests for PUT endpoint
...
- [ ] 5. Enhance DELETE endpoint with cascade logic and add session count endpoint
  - [ ] 5.1 Enhance DELETE /builder/scenarios/{scenario_id} with cascade delete
  ...
  - [ ] 5.2 Add GET /builder/scenarios/{scenario_id}/sessions/count endpoint
  ...
  - [ ]* 5.3 Write property test: Cascade delete removes all sessions and returns correct count (Property 2)
  ...
  - [ ]* 5.4 Write unit tests for enhanced DELETE and session count endpoint
...
- [ ] 7. Frontend: Add new API functions in builder/api.ts
  - [ ] 7.1 Add `updateCustomScenario` and `getScenarioSessionCount` to `frontend/lib/builder/api.ts`
  ...
  - [ ]* 7.2 Write tests for new builder API functions
    - Mock fetch, verify correct URL/method/body for both functions
    - Test location: `frontend/__tests__/lib/builder/api.test.ts`
    - _Requirements: 5.1, 2.1_

- [ ] 8. Frontend: ScenarioEditorModal component
  - [ ] 8.1 Create `ScenarioEditorModal` component
  ...
  - [ ]* 8.2 Write tests for ScenarioEditorModal
...
- [ ] 9. Frontend: Delete confirmation dialog and updated ScenarioSelector
  - [ ] 9.1 Create delete confirmation dialog component
  ...
  - [ ] 9.2 Update ScenarioSelector with edit button and wire modal/dialog
  ...
  - [ ]* 9.3 Write tests for delete confirmation dialog
  ...
  - [ ]* 9.4 Write tests for ScenarioSelector edit button
