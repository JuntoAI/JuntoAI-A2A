...
| `NegotiationStateModel` | `models/negotiation.py` | `session_id`, `scenario_id`, `turn_count`, `max_turns`, `current_speaker`, `deal_status`, `current_offer`, `history`, `warning_count`, `hidden_context`, `agreement_threshold`, `active_toggles` | — |
