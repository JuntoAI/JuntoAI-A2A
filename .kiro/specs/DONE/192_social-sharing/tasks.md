...
- [x] 1. Define share data models and exceptions
  - [x] 1.1 Create `backend/app/models/share.py` with Pydantic V2 models
  ...
  - [x] 1.2 Add `ShareNotFoundError` to `backend/app/exceptions.py`
    - Follow existing `SessionNotFoundError` pattern with share_slug parameter
    - _Requirements: 7.5_

  - [x] 1.3 Write property test: SharePayload round-trip serialization
...
- [x] 2. Implement share store layer (Firestore + SQLite)
  - [x] 2.1 Add `ShareStore` protocol to `backend/app/db/base.py`
  ...
  - [x] 2.2 Implement `FirestoreShareClient` in `backend/app/db/firestore_client.py`
    ...
    - _Requirements: 1.3, 1.4_
  - [x] 2.3 Implement `SQLiteShareClient` in `backend/app/db/sqlite_client.py`
...
- [x] 3. Implement image generator service
  - [x] 3.1 Create `backend/app/services/image_generator.py`
...
- [x] 4. Implement share service (core business logic)
  - [x] 4.1 Create `backend/app/services/share_service.py`
  ...
  - [x] 4.2 Write property test: Slug format and uniqueness
  ...
  - [x] 4.3 Write property test: Idempotent share creation
  ...
  - [x] 4.4 Write property test: Sensitive data exclusion
  ...
  - [x] 4.5 Write property test: Social post required elements
  ...
  - [x] 4.6 Write property test: Social post length constraints
  ...
  - [x] 4.7 Write property test: Mailto link composition
...
- [x] 5. Checkpoint — Backend models, store, and service
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Implement share router and wire into FastAPI app
  - [x] 6.1 Create `backend/app/routers/share.py`
...
- [x] 7. Implement frontend share API client
  - [x] 7.1 Create `frontend/lib/share.ts`
...
- [x] 8. Implement SharePanel UI component
  - [x] 8.1 Create `frontend/components/glassbox/SharePanel.tsx`
  ...
  - [x] 8.2 Integrate SharePanel into `frontend/components/glassbox/OutcomeReceipt.tsx`
...
- [x] 9. Implement public share page
  - [x] 9.1 Create `frontend/app/share/[slug]/page.tsx`
  ...
  - [x] 9.2 Implement `generateMetadata()` for Open Graph and Twitter Card meta tags
  ...
  - [x] 9.3 Write property test: Meta tag generation
...
- [x] 11. Write frontend component tests
  - [x] 11.1 Write vitest tests for SharePanel
  ...
  - [x] 11.2 Write vitest tests for Public Share Page
