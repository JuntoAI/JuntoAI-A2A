...
- [x] 1. Create backend profile models and tier calculator
  - [x] 1.1 Create Pydantic V2 profile models (`backend/app/models/profile.py`)
  ...
  - [x] 1.2 Create tier calculator pure functions (`backend/app/services/tier_calculator.py`)
  ...
  - [x] 1.3 Write property tests for profile validation (Hypothesis)
  ...
  - [x] 1.4 Write property tests for display name trimming (Hypothesis)
  ...
  - [x] 1.5 Write property tests for URL validation (Hypothesis)
    - **Property 5: URL format validation** — generate random strings, verify GitHub/LinkedIn pattern matching accept/reject
    - **Validates: Requirements 5.1, 5.2, 5.4**

  - [x] 1.6 Write property tests for tier determination (Hypothesis)
  ...
  - [x] 1.7 Write property tests for profile completeness (Hypothesis)
  ...
  - [x] 1.8 Write property test for country code validation (Hypothesis)
...
- [x] 3. Create Firestore profile client and email verifier service
  - [x] 3.1 Create profile Firestore client (`backend/app/db/profile_client.py`)
  ...
  - [x] 3.2 Create email verifier service (`backend/app/services/email_verifier.py`)
  ...
  - [x] 3.3 Write property test for profile initialization defaults (Hypothesis)
  ...
  - [x] 3.4 Write property test for profile get-or-create idempotency (Hypothesis)
  ...
  - [x] 3.5 Write property test for verification token generation (Hypothesis)
    - **Property 11: Verification token generation** — generate multiple tokens, verify uniqueness and `expires_at == created_at + 24h`
    - **Validates: Requirements 4.1, 4.2**

- [x] 4. Create profile router with all 4 endpoints
  - [x] 4.1 Implement profile router (`backend/app/routers/profile.py`)
  ...
  - [x] 4.2 Register profile router in FastAPI app (`backend/app/main.py`)
    - Import and include profile router in the `api_router` with `PUT` added to `allow_methods` in CORS middleware
    - _Requirements: 9.1_

  - [x] 4.3 Write property test for profile round-trip persistence (Hypothesis)
  ...
  - [x] 4.4 Write property test for tier upgrade on profile completion (Hypothesis)
  ...
  - [x] 4.5 Write property test for email verification tier 2 upgrade (Hypothesis)
...
- [x] 6. Create auth models, auth service, and auth router
  - [x] 6.1 Create auth Pydantic V2 models (`backend/app/models/auth.py`)
  ...
  - [x] 6.2 Create auth service (`backend/app/services/auth_service.py`)
  ...
  - [x] 6.3 Create auth router (`backend/app/routers/auth.py`)
  ...
  - [x] 6.7 Write property test for Google OAuth ID uniqueness (Hypothesis)
...
- [x] 8. Update existing backend token logic for tier awareness
  - [x] 8.1 Update token reset logic for tier-aware resets
  ...
  - [x] 8.2 Update waitlist signup to set initial balance to 20
  ...
  - [x] 8.3 Write property test for tier-aware token reset (Hypothesis)
    - **Property 12: Tier-aware token reset** — generate users at each tier, verify correct reset balance (20/50/100)
    - **Validates: Requirements 10.2, 10.3, 10.4**

  - [x] 8.4 Write property test for waitlist signup initial balance (Hypothesis)
...
- [x] 10. Update frontend SessionContext and token utilities
  - [x] 10.1 Add tier fields to SessionContext (`frontend/context/SessionContext.tsx`)
  ...
  - [x] 10.2 Update token utility functions (`frontend/lib/tokens.ts`)
  ...
  - [x] 10.3 Update TokenDisplay component (`frontend/components/TokenDisplay.tsx`)
    - Read `dailyLimit` from SessionContext
    - Pass `dailyLimit` to `formatTokenDisplay`
    - _Requirements: 8.1, 8.2, 8.3_

  - [x] 10.4 Write property test for token display format (fast-check)
...
- [x] 11. Update WaitlistForm / Login Form and protected layout
  - [x] 11.1 Update WaitlistForm / Login Form (`frontend/components/WaitlistForm.tsx`)
  ...
  - [x] 11.2 Update protected layout header (`frontend/app/(protected)/layout.tsx`)
    - Make the email `<span>` a clickable `<Link>` to `/profile`
    - _Requirements: 2.1_

- [x] 12. Create profile page with all sections
  - [x] 12.1 Create profile page component (`frontend/app/(protected)/profile/page.tsx`)
  ...
  - [x] 12.2 Create profile API client functions (`frontend/lib/profile.ts`)
  ...
  - [x] 12.3 Create auth API client functions (`frontend/lib/auth.ts`)
  ...
  - [x] 12.4 Create email verification callback page (`frontend/app/(protected)/profile/verify/page.tsx`)
...
- [x] 14. Integration wiring and final validation
  - [x] 14.1 Wire negotiation router to use tier-aware token lookup
  ...
  - [x] 14.2 Write backend integration tests for profile endpoints
  ...
  - [x] 14.3 Write backend integration tests for auth endpoints
  ...
  - [x] 14.4 Write frontend component tests for profile page
  ...
  - [x] 14.5 Write frontend component tests for login form
