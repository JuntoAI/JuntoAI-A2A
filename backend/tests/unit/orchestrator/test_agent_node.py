...
class TestUpdateStateObserver:
    ...
    def test_only_appends_history(self):
        ...
        agent_states = {
            "Analyst": {"role": "Analyst", "name": "Dave", "agent_type": "observer", "model_id": "gemini-3.5-flash", "last_proposed_price": 0.0, "warning_count": 0},
        }
        state = _make_state(
            current_offer=500.0,
...
class TestAgentNodeIntegration:
    ...
    def test_negotiator_node_full_execution(self, mock_router):
        ...
        agents = [_make_agent_config("Buyer", "Alice", "negotiator", "gemini-3.5-flash", "You are a buyer.")]
        agent_states = {
            "Buyer": {"role": "Buyer", "name": "Alice", "agent_type": "negotiator", "model_id": "gemini-3.5-flash", "last_proposed_price": 0.0, "warning_count": 0},
        }
        state = _make_state(
    ...
    def test_observer_node_read_only(self, mock_router):
        ...
        agents = [_make_agent_config("Analyst", "Dave", "observer", "gemini-3.5-flash", "You observe.")]
        agent_states = {
            "Analyst": {"role": "Analyst", "name": "Dave", "agent_type": "observer", "model_id": "gemini-3.5-flash", "last_proposed_price": 0.0, "warning_count": 0},
        }
        state = _make_state(
    ...
    def test_retry_on_parse_failure(self, mock_router):
        ...
        agents = [_make_agent_config("Buyer", "Alice", "negotiator", "gemini-3.5-flash", "You buy.")]
        agent_states = {
            "Buyer": {"role": "Buyer", "name": "Alice", "agent_type": "negotiator", "model_id": "gemini-3.5-flash", "last_proposed_price": 0.0, "warning_count": 0},
        }
